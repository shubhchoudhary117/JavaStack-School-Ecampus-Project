 ...
 *
 * For a detailed overview, check the {@glink features/export-pdf export to PDF} feature documentation.
 */
...
export interface ExportPdfConfig {
     ...
     * ```
     *
     * **Web fonts:** If you want to {@glink features/export-pdf#providing-web-font-styles use web fonts} in your PDF document,
